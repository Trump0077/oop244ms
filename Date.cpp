...
// Revision History
// -----------------------------------------------------------
// Name Jiaheng Wang  Date  July 22  Reason
/////////////////////////////////////////////////////////////////
...
namespace sdds {
   ...
   std::ostream& Date::write(std::ostream& os)const {
       if (!bad()) {
           os << m_year << "/" << right << setw(2) << setfill('0') << m_mon
               << "/" << right << setw(2) << setfill('0') << m_day;
       }
       else {
           os << dateStatus();
       }
   ...
   // Operator- method (Returns the difference between two Dates in days)
   int Date::operator-(Date i)const
   {
